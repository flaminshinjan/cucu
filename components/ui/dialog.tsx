  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "rounded-2xl border border-ink-100 bg-card shadow-[0_30px_80px_-20px_rgba(30,12,10,0.25)]",
    ...
    >
      ...
      <DialogPrimitive.Close
        className="absolute right-3 top-3 rounded-full p-1.5 text-ink-400 hover:bg-cream-100 hover:text-ink-800 transition-colors"
        aria-label="Close"
      >
        <X size={14} />
      </DialogPrimitive.Close>
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn("font-display text-2xl text-ink-800 leading-tight", className)}
    {...props}
  />
));
